    ...
    $(document).on('click', '#gallery-metabox a.gallery-add', function(e) {
        ...
        file_frame.on('select', function() {
            ...
            selection.map(function(attachment, i) {
                ...
                $('#gallery-metabox-list').append('<li class="image_holder"><input type="hidden" name="ale_gallery_id[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + attachment.sizes.thumbnail.url + '"><div class="buttons_manage"><a class="change-image button button-primary button-medium" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Edit</a> <a class="remove-image button button-primary button-medium" href="#">Delete</a></div></li>');
            });
        });
